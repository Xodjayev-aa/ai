...
Aether.icon = function icon(name, size = 16) {
  const paths = {
    ...
    logo: '<path d="M5.2 19.4 12 4.6 18.8 19.4" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>'
      + '<path d="M8.1 14.8h7.8" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>',
